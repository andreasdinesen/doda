...
**v37 er udgivet. Arbejdsmappen er ren.** Alt er pushet.

| | |
|---|---|
| Tests | **178 grønne** (`node --test tests/*.mjs`) |
| Install-script | **119.394 / 126.000 tegn (95 %)** — **6.606 tegn tilbage** — se `PLAN.md` om guidens pris |
