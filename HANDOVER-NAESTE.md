...
**v36 er udgivet. Arbejdsmappen er ren.** Alt er pushet.

| | |
|---|---|
| Tests | **178 grønne** (`node --test tests/*.mjs`) |
| Install-script | **119.350 / 126.000 tegn (95 %)** — **6.650 tegn tilbage** — se `PLAN.md` om guidens pris |
...
Det fylder **119.350 (95 %)**, og build'et **fejler højt** ved loftet.
...
- **En nulstilling bag »kun hvis skærmen skifter« svigter i en undertilstand.**
