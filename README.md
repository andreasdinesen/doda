...
| Version | Ændringer |
|---|---|
| 76 | **To prøveknapper til notifikationer — og datochippen viser nu klokkeslættet.** »Der kom ingen notifikation« kunne være fem ting, og der var intet at se på: fejler en push, sker der bare ingenting. **Send a test** under Notifications sender én med det samme og svarer **pr. enhed** med push-tjenestens egen fejlkode — *kom igennem*, *afvist (403): VapidPkHashMismatch*, eller *abonnementet er væk og er ryddet*. **Vis en her** går uden om push-tjenesten og viser én direkte fra enheden: kommer den frem, men pushen ikke, er det leveringen — kommer den heller ikke, holder telefonen den tilbage, og der er intet i doda at rette. **Og en visningsfejl:** chippen i redigeringsruden viste kun dagen, mens listen viste »today 20:20« — de to skærme sagde altså noget forskelligt om samme opgave, og man kunne med rimelighed tro, at tidspunktet var gået tabt. |
